...
import { sendToDB } from "@/backend/server_actions/vendorsignup";
...
function Page() {
  ...
  const handleForm = async (event) => {
    ...
    // send to db
    const userId = await sendToDB(email, username);
  ...
  return (
    <div className="flex justify-center items-start min-h-screen bg-gray-100 font-normal font-sans">
      <div className="bg-white p-10 rounded-2xl shadow-lg max-w-md w-full text-center mt-5">
        <h1 className="mb-8 text-2xl text-gray-800">Vendor Sign up</h1>
